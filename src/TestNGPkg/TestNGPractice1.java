...
public class TestNGPractice1 {
	...
	@Test(priority=4,groups="Contact details")
	public void keyInEmail() {
	driver.findElement(By.xpath("(//input[@class='form-control'])[3]")).sendKeys("Ramesh32@gmail.com");
	}
	@Test(priority=5,groups="Contact details")
